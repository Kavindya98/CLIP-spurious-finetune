...
class WaterbirdsRobustSimilarDataset(WILDSDataset):
    """
    ...
    _dataset_name = 'waterbirds_robust'
    _versions_dict = {
        '1.0': {
    ...
    def eval(self, y_pred, y_true, metadata, prediction_fn=None):
        ...
        results['adj_acc_avg'] = (
            (results['acc_y:landbird_generic-spurious:birdonland'] * 1341
            + results['acc_y:landbird_generic-spurious:birdonwater'] * 1341
            + results['acc_y:waterbird_generic-spurious:birdonland'] * 1057
